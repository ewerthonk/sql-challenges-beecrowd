...
-- Using pre-built 2989 and 2991 solution
...
SELECT
	...
	media
FROM media_salario
WHERE media IN (SELECT MAX(media) OVER (PARTITION BY departamento) FROM media_salario) 
:

-- Using a solution built from scratch
